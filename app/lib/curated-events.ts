...
export const CURATED_TECH_EVENTS: CuratedTechEvent[] = [
  ...
  },
  {
    ...
    country: "Korea",
    city: "Seoul",
    venue: "COEX Grand Ballroom + Hall B",
    sourceName: "NAVER search result / AI Summit Seoul & Expo",
    sourceUrl: "https://m.site.naver.com/25TB4",
    url: "https://www.aisummitseoul.com/",
    description:
      "AI conference and expo in Seoul covering Agentic AI, enterprise AI, real-world AI transformation, global AI leaders, innovators, startups, and policymakers.",
    tags: ["AI", "Agentic AI", "enterprise", "startup", "technology", "conference"],
    category: "AI",
    resultType: "searched",
    lastVerified: "2026-06-17",
  ...
  {
    title: "Busan International Mobility Show 2026",
    country: "Korea",
    city: "Busan",
    venue: "BEXCO",
    sourceName: "NAVER search result / Busan Mobility Show",
    sourceUrl: "https://www.busan.go.kr/eng/bsevents/1717098",
    url: "https://bimos.co.kr/",
    description:
      "Future mobility event in Busan focused on AI-powered autonomous driving, electrification, smart mobility, automotive technology, and future mobility industry innovation.",
    tags: ["mobility", "AI", "autonomous driving", "electrification", "smart city", "technology"],
    category: "Mobility",
    resultType: "searched",
    lastVerified: "2026-06-17",
